...
-- 18、大学管理表
-- ----------------------------
drop table if exists portal_university;
create table portal_university (
  university_id       bigint(20)      not null auto_increment    comment '大学ID',
  ...
  university_desc     text                                       comment '大学描述',
  status              char(1)         default '0'                comment '状态（0正常 1停用）',
  create_by           varchar(64)     default ''                 comment '创建者',
  create_time         datetime                                   comment '创建时间',
  update_by           varchar(64)     default ''                 comment '更新者',
...
) engine=innodb auto_increment=100 comment = '大学管理表';

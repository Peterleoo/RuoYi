(function () {
  ...
  const WIDGET_CONFIG = {
    ...
    translations: {
      zh: {
        ...
        textAlignCenter: "居中",
        textAlignLeft: "左对齐",
        highlightLinks: "链接加下划线",
        hideImages: "隐藏图片",
        highlightHeadings: "高亮标题",
        textMagnifier: "光标阅读辅助",
        reset: "重置",
  ...
  class AccessibilityWidget {
    constructor() {
      ...
      this.currentLang =
        this.settings.language && WIDGET_CONFIG.translations[this.settings.language]
          ? this.settings.language
          : WIDGET_CONFIG.defaultLang;
                ...
                <div class="a11y-header">
                    ...
                    <div class="a11y-header-actions">
                        <div class="a11y-lang-toggle">
                            <button class="a11y-lang-btn ${this.currentLang === "zh" ? "active" : ""}" data-lang="zh">中文</button>
    ...
    changeLanguage(lang) {
      if (!WIDGET_CONFIG.translations[lang]) {
        lang = WIDGET_CONFIG.defaultLang;
      }

    ...
    public AjaxResult uploadFile(MultipartFile file, String type) {
        try {
            ...
            if (type.equals("image")) {
                ...
                // 媒体文件
                if (!MimeTypeUtils.isVideo(extension) && !MimeTypeUtils.isAudio(extension) && !extension.equals("pdf")) {
            ...
            String saveName = FileUploadUtils.upload(uploadPath, file);
            String url = serverConfig.getUrl() + saveName;
